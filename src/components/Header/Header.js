        ...
        <header className="header">
            <nav className="header__nav-bar">
                ...
                <ul className="header__nav-items">
                    ...
                    <Link to="/saved-news" className={props.isSignedIn ? 'header__nav-item' : 'header__nav-item_hidden'} rel="noreferrer noopener" onClick={props.showSavedPage}>Saved articles</Link>
                    <Link to="/" className={props.isSignedIn ? "header__log-button_signed" : "header__log-button"} onClick={props.isSignedIn ? props.onLogout : props.onLogin}>
                        {props.isSignedIn ? props.currentUsername : 'Sign in'}
            ...
            <section className="header__search">
                ...
                <form className="header__search-form" onSubmit={handleSearchSubmit}>
                    <input className="header__search-input" placeholder="Enter topic" type='text' name='keyword' formNoValidate value={props.keyword} onChange={handleKeywordChange}/>
